...
public class SemanticPass extends VisitorAdaptor {
	...
	public void visit(VarIdentBrackets var) {
		...
		if(this.currentDeclType != Tab.noType) {
			Obj newObject = Tab.insert(Obj.Var,var.getIdent(), new Struct(Struct.Array, this.currentDeclType));
//			if(isFinal) {
//				Tab.insert(Obj.Var,"final" + var.getIdent(), new Struct(Struct.Array, this.currentDeclType));
//				newObject.setFpPos(1);
//				
//			}
...
//	public void visit(FinalOptK1 fin) {
//		isFinal = true;
//	}
...
//	public void visit(ExprK9 e) {
//		e.struct = TabExtended.charType;
//	}
